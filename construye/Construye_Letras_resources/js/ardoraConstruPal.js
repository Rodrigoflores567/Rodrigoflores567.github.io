...
$("#help_div").html("<img tabindex='0' id='playSound' class='imaLeft' src='Construye_Letras_resources/media/' alt='Play' align='left'>"+ "<p>" +ConstruPalWords(cp_que[jobindex[indexGame-1]])+ "</p>");
