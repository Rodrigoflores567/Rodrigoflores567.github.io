...
taboaContidos[0]=new act("Ordenar Frases","Ordenar Frases","","<object width='100%' height='420' type='text/html' data='frases/index.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("Ordenar Parrafos","Ordenar Parrafos","","<object width='100%' height='420' type='text/html' data='P__rrafos/index.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("Colorear segun leyenda","Colorear segun leyenda","","<object width='100%' height='420' type='text/html' data='Leyenda/index.htm'></object>",false,"",true,false,false);
